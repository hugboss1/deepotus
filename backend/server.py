...
# ---------------------------------------------------------------------
import access_card as access_card_mod  # noqa: E402
...
async def access_card_verify(req: access_card_mod.AccessCardVerifyRequest):
    ...
    # Lightweight sanitization: allow alphanumeric + dashes
...
@api_router.get("/access-card/status")
...
@api_router.get("/access-card/image/{accred}")
